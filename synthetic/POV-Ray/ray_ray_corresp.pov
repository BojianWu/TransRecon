...
#macro Display(image)
    box {
        ...
        translate <-texScaleX/2, -texScaleY/2, bkgPos + texScaleZOffset>
    }
#end
...
#declare idx = clock / (1.0/11.0) + 1;
object {
    Display(concat("ref_gray/col_gray_", str(idx,-2,0), ".png"))
}                              
