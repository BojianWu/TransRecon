...
namespace Directory
{
	static inline std::vector<std::string> GetListFiles(const std::string& path, const std::string & exten, bool addPath = true)
	{
	...
	static inline std::vector<std::string> GetListFolders(const std::string& path, const std::string & exten, bool addPath = true)
	{
		std::vector<std::string> list;
		std::string path_f = path + "/" + exten;
		list.clear();
	...
	static inline std::vector<std::string> GetListFilesR(const std::string& path, const std::string & exten, bool addPath = true)
	{
